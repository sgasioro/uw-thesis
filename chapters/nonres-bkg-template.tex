	...
	\foreach \region in {Control,Validation}{
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of $\Delta R$ between the closest Higgs Candidate
		      ...
		      jet $\eta$ before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region.}
		...
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of $p_{T}$ of the 2nd and 4th leading Higgs Candidate jets and the $p_{T}$ of the di-Higgs system before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region.}
		...
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of the number of jets before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region. A minimum of 4 jets is required in each event in order to form Higgs candidates.}
		...
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of $p_{T}$ of the 1st and 3rd leading Higgs Candidate jets and $\Delta R$ between Higgs candidates before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region.}
		...
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of $\eta$ of the 1st, 2nd, and 3rd leading Higgs Candidate jets before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region.}
		...
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of $\eta$ of the 4th leading Higgs Candidate jet and the $p_{T}$ of the leading and subleading Higgs candidates before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region.}
		...
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of mass of the leading and subleading Higgs candidates and of the di-Higgs system before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region.}
		...
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of $\Delta \phi$ between jets in the leading and subleading Higgs candidates before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region.}
		...
		\begin{figure}[ht]
		    ...
		    \caption{\textbf{Non-resonant Search (\breg)}: Distributions of the top veto variable, $X_{\PW\Pqt}$, before and after CR derived reweighting for the 20\yr\space \breg\space \region\space Region. Reweighting is done after the cut on this variable is applied.}
