...
The results for the non-resonant analysis presented here are preliminary and only include 
...
\begin{figure}[ht]
  ...
  \caption{\label{fig:res-sr-mhh} Signal region agreement of the background estimate and 
...
in Figure \todo{insert} for the the control region and Figure \todo{insert} for 
the the validation region. A background-only profile likelihood fit is run for the distribution in the signal 
region, and results with the Standard Model $HH$ signal overlaid are shown for $4b$ in Figure \ref{fig:nonres-sr-mhh-4b}
and $3b1l$ in Figure \ref{fig:nonres-sr-mhh-3b1l}. Note that 
the plots show the sum across all years, but the signal extraction fit and background estimate are run with the 
...
\begin{figure}[ht]
  ...
  \hspace*{-2cm}
  \subfloat{
    \includegraphics[width=1.2\textwidth]{figures/post-bonly-fit-4b-nonres-with-SM-HH.pdf}
  }
  \caption{\label{fig:nonres-sr-mhh-4b} \textbf{Non-resonant Search}: Signal region agreement of the background estimate and observed data after a background-only profile likelihood fit for the $4b$ channels, with Standard Model 
  signal overlaid for reference. Modeling is generally quite good near the Standard Model peak, but disagreements 
  are seen at very low and high masses. A deficit is present in low $\Delta\eta_{HH}$ bins near \SI{600}{\GeV}.}
\end{figure}
...
\begin{figure}[ht]
  \centering
   \hspace*{-2cm}
  \subfloat{
    \includegraphics[width=1.2\textwidth]{figures/post-bonly-fit-3b1l-nonres-with-SM-HH.pdf}
  }
  \caption{\label{fig:nonres-sr-mhh-3b1l} \textbf{Non-resonant Search}: Signal region agreement of the background estimate and observed data after a background-only profile likelihood fit for the $3b1l$ channels, with Standard Model 
  signal overlaid for reference. Conclusions are very similar to the $4b$ channels, with generally good modeling near 
  the Standard Model peak, but disagreements at very low and high masses. A deficit is present near \SI{600}{\GeV}.}
\end{figure}
...
is a real effect, but is rather due to a mis-modeling of the background at low mass, where the $\min{\Delta R}$ pairing 
