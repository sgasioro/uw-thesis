...
are sorted by the scalar sum of constituent jet $p_{T}$. The angular separation,
...
referred to as $\min{\dr}$.

\section{Background Reduction and Top Veto}
% Back to main figure directory for this section
\def\secforfig{evtselection}
\def\figsversion{\oldfigsversion}
